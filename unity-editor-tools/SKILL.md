...
Charger `references/editor-patterns.md` et utiliser le template adapte au type choisi a l'etape 2 :
- `CustomEditor` (IMGUI ou UI Toolkit pour Unity 6+)
- `PropertyDrawer`
- `EditorWindow` (avec tabs et toolbar)
- `MenuItem` (avec validation)

Le fichier contient aussi des patterns IMGUI/UITK reutilisables (layouts, foldouts, ReorderableList, binding SerializedObject).
