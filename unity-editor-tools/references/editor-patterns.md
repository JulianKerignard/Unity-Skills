# Templates et patterns Editor

Charger ce fichier a l'etape 4 du workflow (generation du script) selon le type choisi dans l'arbre de decision.
...
Pour les nouveaux projets (Unity 6+), preferer UI Toolkit a IMGUI pour les EditorWindow et les CustomEditor complexes. Pour les PropertyDrawer simples, IMGUI reste acceptable.
