# Templates de prototypes par genre

Charger ce fichier quand le SKILL.md choisit un template via l'arbre de decision. Chaque template indique les scripts minimaux et le setup scene.
