...
Voir `references/proto-templates.md` pour les recettes detaillees (scripts + setup scene) :
- 3D Platformer
- FPS
- Top-Down 2D
- Puzzle (grid-based)
...
Charger ce fichier quand l'arbre de decision aboutit a un template specifique.
